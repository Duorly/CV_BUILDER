...
import { User, Briefcase, GraduationCap, Languages, Award, Plus, Trash2, X } from 'lucide-react';
                        ...
                        <div className="details-editor">
                            ...
                            {exp.details.map((detail, dIdx) => (
                                <div key={dIdx} className="detail-row">
                                    ...
                                    />
                                    <button className="remove-btn-icon-tiny" onClick={() => removeDetail(index, dIdx)}>
                                        <X size={12} />
                                    </button>
                                </div>
                            ))}
